package io.studio.githubdemo.pref;
...
public class PrefsHelper {
    ...
    private static final String PREF_NAME = "PrefsHelper";
    ...
    public interface PreferenceKey {
        ...
        String token="token";
        String googleContacts="googleContacts";
        String linkedInEmail="linkedInEmail";
